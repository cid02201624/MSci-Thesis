...
Date: 26/02/2026
Description: Training loop for the final model, with time features. This is the main training loop 
...
def main():
    ...
    ckpt_path = "checkpoints9/best.pt"
    resume_path = None  # set to "checkpoints5/best.pt" to resume

    fig_dir = "training_figures9"
