...
from Model_10_SOTA.Training import JointPaperCNNGWWithTime, load_checkpoint
...
if __name__ == "__main__":
    checkpoint_path = "Model_10_SOTA/training_figures10_460k/best.pt"#"Model_5/training_figures5_freeze_unfreeze_freeze/best.pt"

    events = get_o4_events_with_h1_l1_data(save=True)
    ...
    df_predictions.to_csv(os.path.join(out_dir, "real_events_predictions_10.csv"), index=False)
