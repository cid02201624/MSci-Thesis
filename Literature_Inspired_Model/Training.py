...
Date: 26/02/2026
Description: Training loop for the two-head literature-inspired model, with time features. This is the main training loop 
...
def main():
    ...
    start_epoch = 0
    best_val = -float("inf")
    ckpt_path = "checkpoints5/best.pt"
    resume_path = None  # set to "checkpoints5/best.pt" to resume

    fig_dir = "training_figures5"
