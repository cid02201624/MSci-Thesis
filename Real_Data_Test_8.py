...
from Model_8.Training import MultiViewConvNeXtGWWithTime, load_checkpoint
...
if __name__ == "__main__":
    checkpoint_path = "Model_8/best.pt"#"Model_5/training_figures5_freeze_unfreeze_freeze/best.pt"
    ...
    df_predictions.to_csv(os.path.join(out_dir, "real_events_predictions8.csv"), index=False)
